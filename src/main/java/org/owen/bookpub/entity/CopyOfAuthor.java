 ...
 */
@Entity
@JsonIdentityInfo(generator=ObjectIdGenerators.PropertyGenerator.class,property="id", scope=CopyOfAuthor.class)
public class CopyOfAuthor
{
	@Id
	@GeneratedValue
	private Long id;
	...
	protected CopyOfAuthor()
	{
	}

	public CopyOfAuthor(String firstName, String lastName)
	{
